...
$Bxr16$O:	$Bxr16.c;	$(CC) $(CFLAGS) -c -Isrc -o $@ $Bxr16.c
...
$Bxr16.c:	$Blburg$E src/xr16.md;      $Blburg src/xr16.md      $@
...
clean::		testclean
		$(RM) $B*$O
		$(RM) $Bdagcheck.c $Balpha.c $Bmips.c $Bx86.c $Bxr16.c $Bsparc.c $Bx86linux.c
